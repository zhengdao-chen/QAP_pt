...
# def train_mcd_single(gnn, optimizer, logger, W, labels, n_classes, it):
#     start = time.time()
#
#     labels = labels.type(dtype_l)
#
...
#         loss_single, acc_single = train_mcd_single(gnn, optimizer, logger, W, labels, n_classes, it)
#         loss_lst[it] = loss_single
#         acc_lst[it] = acc_single
#     print ('Avg train loss', np.mean(loss_lst))
#     print ('Avg train acc', np.mean(acc_lst))
#
# def test_mcd_single(gnn, logger, W, labels, n_classes, iter):
#
#     start = time.time()
#
#     labels = labels.type(dtype_l)
...
#     for it in range(iters):
#         inputs, labels, W = gen.sample_single(it, cuda=torch.cuda.is_available(), is_training=False)
#         loss_single, acc_single = test_mcd_single(gnn, logger, W, labels, n_classes, it)
#         loss_lst[it] = loss_single
#         acc_lst[it] = acc_single
